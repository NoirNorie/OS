...
extern void Trampoline(unsigned short CodeSelector, unsigned short DataSelector, unsigned ldtSelector, unsigned long entry);
...
static int Spawn_Program(char *exeFileData, struct Exe_Format *exeFormat)
{
  ...
  unsigned short codeSelector, dataSelector, ldtSelector;
...
//			       (virtSize/PAGE_SIZE)+10,	 // num pages
  ...
  ldtSelector = Selector( 0, true, Get_Descriptor_Index( desc ) );
*/
/*
...
////////////////////////////////////////////////////////////
  ...
  Trampoline(codeSelector, dataSelector, ldtSelector, exeFormat->entryAddr); 
